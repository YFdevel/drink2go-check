!function (t, e) {
  ...
  function N(t, e) {
    ...
    var r = 0 <= e.indexOf("tap"), n = 0 <= e.indexOf("drag"), i = 0 <= e.indexOf("fixed"), o = 0 <= e.indexOf("snap"),
      ...
      u = 0 <= e.indexOf("drag-all"), e = 0 <= e.indexOf("smooth-steps");
    if (i) {
  ...
  function T(t, f, o) {
    var i, n, l, u, s, a, c = window.navigator.pointerEnabled ? {
      ...
      p = window.CSS && CSS.supports && CSS.supports("touch-action", "none") && function () {
        ...
        return t
      }(), d = t, S = f.spectrum, h = [], m = [], g = [], v = 0, b = {}, x = !1, y = t.ownerDocument,
      w = f.documentElement || y.documentElement, E = y.body, r = "rtl" === y.dir || 1 === f.ort ? 0 : 100;
    ...
    function C(t, e) {
      ...
      return P(n, f.cssClasses.touchArea), n.setAttribute("data-handle", String(e)), f.keyboardSupport && (n.setAttribute("tabindex", "0"), n.addEventListener("keydown", function (t) {
        return function (t, e) {
          ...
          var s = t.key.replace("Arrow", ""), a = s === i[0], l = s === i[1], i = s === n[0] || s === r[0] || a,
            n = s === n[1] || s === r[1] || l, r = s === o[0], o = s === o[1];
          if (!(i || n || r || o)) return !0;
          if (t.preventDefault(), n || i) {
            var u = i ? 0 : 1, u = st(e)[u];
            if (null === u) return !1;
    ...
    function D(d) {
      ...
      return (h = h.slice().sort(function (t, e) {
        ...
        var r, n, i, o, s, a, l, u, t = t, c = h[e + 1], p = d.mode === ut.PipsMode.Steps,
    ...
    function z(n, i, o, s) {
      function e(t) {
        var e, r = function (e, t, r) {
          var n = 0 === e.type.indexOf("touch"), i = 0 === e.type.indexOf("mouse"), o = 0 === e.type.indexOf("pointer"),
            s = 0, a = 0;
    ...
    function Y(a) {
      ...
      }), a.tap && z(c.start, i, q, {}), a.hover && z(c.move, i, X, {hover: !0}), a.drag && u.forEach(function (e, t) {
        var r, n, i, o, s;
    ...
    gt(t = d, f.cssClasses.target), 0 === f.dir ? gt(t, f.cssClasses.ltr) : gt(t, f.cssClasses.rtl), 0 === f.ort ? gt(t, f.cssClasses.horizontal) : gt(t, f.cssClasses.vertical), gt(t, "rtl" === getComputedStyle(t).direction ? f.cssClasses.textDirectionRtl : f.cssClasses.textDirectionLtr), i = P(t, f.cssClasses.base), function (t, e) {
      ...
      g.forEach(function (t) {
        var e = l[t], r = G(m, t, 0, !0, !0, !0), n = G(m, t, 100, !0, !0, !0), i = s[t],
    ...
    var lt = {
      destroy: function () {
        ...
        return g.map(st)
      }, on: I, off: W, get: ot, set: it, setHandle: function (t, e, r, n) {
